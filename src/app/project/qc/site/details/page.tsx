...
async function getSiteProgress(siteId: string, siteName?: string): Promise<{ 
  ...
  try {
    ...
    // Gabungkan semua sections dari semua dokumen tasks dengan siteName/siteId sama
    let allSections: any[] = [];
...
const SiteDetailPage = () => {
  ...
  useEffect(() => {
    async function fetchSites() {
      ...
      // Generate nomor urut berdasarkan urutan data (tidak filter berdasarkan user login)
                        ...
                        {paginatedData.map((row, index) => (
                          ...
                          >
                            ...
                            <td 
                              ...
                              onClick={() => router.push(`/project/qc/site/preview?siteId=${row.siteId}&division=PERMIT`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/qc/site/preview?siteId=${row.siteId}&division=SND`)}
                            ...
                            <td 
                              ...
                              onClick={() => router.push(`/project/qc/site/preview?siteId=${row.siteId}&division=CW`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/qc/site/preview?siteId=${row.siteId}&division=EL`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/qc/site/preview?siteId=${row.siteId}&division=Document`)}
                            ...
                            <td className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap">
                              <div className="flex justify-center items-center space-x-3">
                                <button
                                  onClick={() => router.push(`/project/qc/site/preview?siteName=${encodeURIComponent(row.siteName)}`)}
