...
const Dashboard = () => {
  ...
  }, [picFilter, rpmFilter, dateRange, siteData, selectedCity, selectedPieFilter, allTasks, searchTerm]);
      ...
      <div className="flex-1 p-8 overflow-auto relative">
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mb-8">
            ...
            {(rpmFilter || picFilter || dateRange.start || dateRange.end || searchTerm) && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {searchTerm && (
                    <span className="inline-flex items-center space-x-1 bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-xs font-medium">
                        ...
                        {paginatedData.map((item, index) => (
                          ...
                          >
                            ...
                            <td 
                              ...
                              onClick={() => router.push(`/project/top/site/preview?siteName=${item.siteName}&division=PERMIT`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/top/site/preview?siteName=${item.siteName}&division=SND`)}
                            ...
                            <td 
                              ...
                              onClick={() => router.push(`/project/top/site/preview?siteName=${item.siteName}&division=CW`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/top/site/preview?siteName=${item.siteName}&division=EL`)}
                            ...
                            <td 
                              className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap cursor-pointer hover:bg-blue-50 transition-colors duration-200"
                              onClick={() => router.push(`/project/top/site/preview?siteName=${item.siteName}&division=Document`)}
                            ...
                            <td className="p-2 text-center border border-gray-300 text-gray-800 text-sm whitespace-nowrap">
                              <div className="flex justify-center items-center space-x-3">
                                <button
                                  onClick={() => router.push(`/project/top/site/preview?siteName=${encodeURIComponent(item.siteName)}`)}
