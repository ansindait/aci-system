...
const Dashboard = () => {
  ...
  const filteredSiteData = useMemo(() => {
    ...
    // Filter by PIC - only show sites where the logged-in user is assigned as PIC
    filtered = filtered.filter(site => 
      (site.picPermit && site.picPermit.toLowerCase() === loginName) ||
      (site.picSnd && site.picSnd.toLowerCase() === loginName) ||
      (site.picCw && site.picCw.toLowerCase() === loginName) ||
      (site.picEl && site.picEl.toLowerCase() === loginName) ||
      (site.picDocument && site.picDocument.toLowerCase() === loginName) ||
      (site.pic && site.pic.toLowerCase() === loginName)
    );
    ...
    return filtered;
  }, [siteData, dateRange, allTasks, loginName]);
  ...
  const filteredDetailsData = useMemo(() => {
    ...
    return result;
  }, [dateRange, siteData, selectedCity, selectedPieFilter, allTasks]);
