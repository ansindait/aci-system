...
const ProfileSettingsPage = () => {
  const [profile, setProfile] = useState<UserProfile>({
    name: '', nik: '', email: '', division: '', position: '', city: '', bank: '', bankNo: '', rpm: '', region: ''
  });
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2">RPM</label>
                    <input name="rpm" value={profile.rpm} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" />
                  </div>
                  <div>
                    <label className="block text-gray-700 text-sm font-bold mb-2">Region</label>
                    <input name="region" value={profile.region} onChange={handleChange} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" />
                  </div>
                </div>
